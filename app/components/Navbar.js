...
export default function Navbar() {
  ...
  return (
    <>
      {showToast && (
        <div className="fixed top-4 right-4 z-50 max-w-md bg-green-50 border-l-4 border-green-500 px-4 py-3 shadow-md rounded-md flex items-center">
          <div className="text-green-700">
            <p className="font-medium">Environment reset completed!</p>
            <p className="text-sm">Fingerprint cookies cleared, latency reset, and new identification process started.</p>
          </div>
          <button 
